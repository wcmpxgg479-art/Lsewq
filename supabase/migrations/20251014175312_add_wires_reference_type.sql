/*
  # Add wires reference type to default reference types

  1. Changes
    - Update the initialize_default_reference_types function to include 'wires' reference type
    - This will add "Провод" as a new reference type option for all users
...
-- Update function to initialize default reference types including wires
